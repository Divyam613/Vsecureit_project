                ...
                <div className="container1">
                    <div className="row1">
                        <div className="">
                            <div className="\">
                                <figure >
                                    <img className="image" src="./assets/informationmain-left-sec-img.png" alt="informationmain-left-sec-img" />
                                </figure>
                            </div>
                        </div>
                        <div className="">
                            ...
                            <div className="para_about">
                                ...
                                Our comprehensive courses and hands-on training programs are designed to equip our students with the skills and knowledge needed to excel in the field of computer and cyber security. At V-SecurIT Solutions, we prioritize the success and security of our clients, and we are dedicated to providing top-notch training and support.
                                    {/* <li><i className=""></i>Aute irure dolor in reprehenderit in voluptate velit esse mollitia.</li>
                                    <li><i className=""></i>dolore eu fugiat nulla pariatur excepteur sint occaecat distincto.</li>
                                    <li><i className=""></i>Non proident, sunt in culpa qui officia deserunt mollit assumea.</li>
                                    <li><i className=""></i>Laborum incidunt ut labore et dolore magnam rugiat  occaecai.</li> */}
                                </ul>
                            </div>
                        </div>
                    </div>
